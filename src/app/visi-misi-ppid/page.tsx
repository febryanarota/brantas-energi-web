...
export default function Page() {
    ...
    const visi = "Lorem ipsum dolor sit amet consectetur adipisicing Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt, adipisci molestiae! Culpa.elit. Ipsum eum sapiente beatae harum numquam aspernatur facere maiores. Velit asperiores sapiente vero in doloribus nam fugit! Ex?"
    const misi = [
            ...
            <div className="w-full flex flex-col items-center py-10">
                <Container>
                    <div className="flex flex-col gap-10">
                        <div>
                            <h2 className="text-3xl font-bold tracking-wider border-l-3 border-primaryYellow p-2 mb-5">Visi</h2>
                            <p className="text-justify">{visi}</p>
                        </div>
                        <div>
                            <h2 className="text-3xl font-bold tracking-wider border-l-3 border-primaryYellow p-2 mb-5">Misi</h2>
