...
export default function Page() {
    const data: DataItem[] = [
        ...
        {
            title: "Peraturan Komisi Informasi Nomor 2 Tahun 2016 Tentang Tata Cara Pemeriksaan Setempat",
            filePath: "/regulasi-informasi-publik"
        },
        {
            title: "Peraturan Komisi Informasi Nomor 1 Tahun 2013 Tentang Penyelesaian Sengketa Informasi Publik",
            filePath: "/regulasi-informasi-publik"
        },
        {
    ...
    return (
        <div className="pb-20 min-h-screen">
           ...
           <div className="flex flex-col items-center">
                <Container>
                    <h2 className="text-3xl">Peraturan Mengenai <br />Keterbukaan Informasi Publik</h2>
                    ...
                    <ul className="gap-4 flex flex-col">
                        {
                            data.map((item, index) => (
                                <li key={index}>
                                    <a href={item.filePath} className="hover:underline font-semibold hover:text-primaryYellow transition-colors duration-200 ease-in-out">
                                        {item.title}
                                    </a>
                                </li>
                            ))
