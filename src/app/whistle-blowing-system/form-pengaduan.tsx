...
export default function FormPengaduan() {
  return (
    <div className="flex flex-col items-center w-full mt-5">
      <p className="text-black font-medium max-w-2xl w-full mb-2">Pengisian Formulir Informasi data</p>
      <form
        action=""
      ...
      >
        ...
        <p className="w-full font-medium underline mt-5">Pihak yang Diduga Terlibat</p>
