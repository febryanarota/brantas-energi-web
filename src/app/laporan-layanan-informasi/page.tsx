...
export default function Page() {
  const data: DataItem[] = [
    ...
    {
      title: "Form Permohonan Informasi Publik",
      filePath: "/laporan-layanan-informasi",
    },
    {
      title: "Ringkasan Laporan Tahun 2023",
      filePath: "/laporan-layanan-informasi",
    },
    {
      title: "Alasan Pemohon Publik Mengajukan Keberatan",
      filePath: "/laporan-layanan-informasi",
    },
    {
      title: "Alasan Penolakan Informasi Publik",
      filePath: "/laporan-layanan-informasi",
    },
    {
